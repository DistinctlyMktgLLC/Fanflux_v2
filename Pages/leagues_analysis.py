...
def filter_dataframe(df, selected_fandom_levels, selected_races, selected_leagues, selected_teams, selected_income_levels):
    filtered_df = df.copy()
...
def app():
    ...
    # Apply filters
    filtered_df = filter_dataframe(df, selected_fandom_levels, selected_races, selected_leagues, selected_teams, selected_income_levels)
