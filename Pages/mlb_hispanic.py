...
def app():
    ...
    st.set_page_config(page_title="MLB Hispanic Fans", page_icon="⚾", layout="wide")

    # Load data from Parquet file
    @st.cache_data
    def load_data():
        return pd.read_parquet('data/Fanflux_Intensity_MLB_Hispanic.parquet')
    ...
    st.title("Interactive Map of MLB Hispanic Fans")
